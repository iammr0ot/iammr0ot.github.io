...
Quick Google Search reveals that this version is vulnerable to command injection. You can learn more about it [here](https://michalszalkowski.com/security/pentesting-ports/6379-redis)  (R2)
